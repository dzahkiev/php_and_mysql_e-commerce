<?php /* Smarty version 2.6.25-dev, created on 2015-10-03 00:19:44
...
<tr>
<th width="200">Название отдела</th>
<th>Описание</th>
<th width="240">&nbsp;</th>
</tr>
...
<td>
<?php echo '<textarea name="description" rows="6" cols="80">'; ?><?php echo $this->_tpl_vars['obj']->mDepartments[$this->_sections['i']['index']]['description']; ?><?php echo '</textarea>'; ?>
...
<input type="submit" name="submit_delete_dept_<?php echo $this->_tpl_vars['obj']->mDepartments[$this->_sections['i']['index']]['department_id']; ?>
" value="Delete" />
</td>
</tr>
<?php else: ?>
